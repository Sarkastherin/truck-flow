...
export const atributosConMetadata: AtributoMetadata[] = [
  ...
  },
  {
    ...
    label: "Alto",
    fieldType: "number",
    placeholder: "Ingrese alto en milimetros, si no aplica, ingrese 0",
    min: 0,
    unit: "mm",
  },
  {
  ...
  },
  {
    ...
    fieldType: "number",
    placeholder: "Medida en milimetros, si no aplica, ingrese 0",
    min: 0,
    unit: "mm",
  },
  {
    ...
    fieldType: "number",
    placeholder: "Altura en milimetros, si no aplica, ingrese 0",
    min: 0,
    unit: "mm",
  },
  {
